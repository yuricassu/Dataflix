    ...
    <div className="w-full relative overflow-hidden bg-black max-h-[500px]">
      ...
      >
        {carouselItems.map((item) => (
          ...
          >
            <Link href={item.link} className="absolute inset-0 block z-10">
              ...
              <div className="absolute inset-0 flex items-center">
                <div className="hidden sm:block ml-4 sm:ml-8 mr-4 sm:mr-8 text-white max-w-2xl">
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-4">
                    <span className="inline-block bg-red-600 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg font-semibold hover:bg-red-700 transition-colors">
                      Saiba Mais
                    </span>
                  </div>
                </div>
